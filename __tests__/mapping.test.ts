...
test('maps event without inventing missing fields or price', () => {
  const e = mapEvent({
    id: 15751,
    name: 'TAAI ABHINANDANAMALA 2026',
    slug: 'taai-abhinandanamala-2026',
    description: '<p>Members only</p>',
    short_description: '',
    permalink: 'https://taai.net.au/cart/taaievents/taai-abhinandanamala-2026/',
    is_in_stock: true,
    images: [],
    attributes: [],
    extensions: {},
